<div>
        ...
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 relative z-10">
            ...
            <div class="lg:w-[55%] text-white z-10 text-center lg:text-left">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-black leading-[1.15] mb-6 drop-shadow-lg text-white">
                    Menjadi <span class="text-teal-200">Mitra Armada</span> <br class="hidden lg:block">
                    Siaga Ambulans
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="{{ route('register.mitra') }}" class="group relative inline-flex justify-center items-center gap-2 bg-white text-[#009CA6] px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-50 transition-all shadow-[0_8px_30px_rgb(0,0,0,0.2)] hover:scale-105">
                        Daftar Sebagai Mitra Armada
                        <svg class="w-6 h-6 text-[#009CA6] group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white p-8 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(0,156,166,0.15)] hover:-translate-y-2 transition-all duration-300 border border-slate-100 group">
                    <div class="w-14 h-14 bg-[#009CA6]/10 text-[#009CA6] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <h3 class="text-xl font-bold text-[#0F2747] mb-3">Optimalisasi Armada</h3>
                    <p class="text-slate-600 font-medium leading-relaxed">
                        Ambulans yang tadinya diam di pool kini bisa dikerahkan untuk membantu lebih banyak umat yang membutuhkan.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(0,156,166,0.15)] hover:-translate-y-2 transition-all duration-300 border border-slate-100 group">
                    ...
                    <h3 class="text-xl font-bold text-[#0F2747] mb-3">Manajemen Digital Terpadu</h3>
                    <p class="text-slate-600 font-medium leading-relaxed">
                        Dapatkan akses ke dasbor sistem Siaga Ambulans untuk memantau aktivitas, lokasi, dan riwayat perjalanan armada Anda.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(0,156,166,0.15)] hover:-translate-y-2 transition-all duration-300 border border-slate-100 group">
                    ...
                    <h3 class="text-xl font-bold text-[#0F2747] mb-3">Perluas Jangkauan Amal</h3>
                    <p class="text-slate-600 font-medium leading-relaxed">
                        Jadikan armada Anda sebagai bagian dari ekosistem darurat terbesar di Cilacap yang terpercaya dan terorganisir.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(0,156,166,0.15)] hover:-translate-y-2 transition-all duration-300 border border-slate-100 group">
                    ...
                    <h3 class="text-xl font-bold text-[#0F2747] mb-3">Sinergi dengan Relawan</h3>
                    <p class="text-slate-600 font-medium leading-relaxed">
                        Jika armada Anda kekurangan supir, sistem ini siap menghubungkan ambulans Anda dengan jaringan pengemudi siaga kami.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 px-6 lg:px-12 bg-slate-50 border-y border-slate-100">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="relative rounded-[2rem] overflow-hidden shadow-2xl h-[450px] md:h-[550px]" 
                    ...
                    <template x-for="(slide, index) in slides" :key="index">
                        <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out" 
                            ...
                            <img :src="slide.image" alt="Melayani dengan hati" class="w-full h-full object-cover">
                            <!-- overlay -->
                    ...
                    <div class="absolute bottom-6 left-0 right-0 flex justify-center gap-3 z-10">
                        <template x-for="(slide, index) in slides" :key="index">
                            <button @click="currentSlide = index" 
                                    ...
                                    :class="currentSlide === index ? 'w-8 bg-[#009CA6]' : 'w-2 bg-white/50 hover:bg-white/80'">
                            </button>
                        </template>
                    </div>
                </div>
            ...
            <div class="order-1 lg:order-2 space-y-8">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#009CA6]/10 text-[#009CA6] font-bold text-sm uppercase tracking-wider">
                    Kolaborasi Kebaikan
                </div>
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-black text-[#0F2747] leading-[1.2] tracking-tight">
                    Wujudkan Kepedulian Lewat Armada Anda
                </h2>
                <div class="w-20 h-1.5 bg-[#009CA6] rounded-full"></div>
                <p class="text-lg md:text-xl text-slate-600 font-medium leading-relaxed">
                    Ambulans Anda memiliki potensi besar untuk menjadi jembatan kehidupan bagi banyak orang. Dengan mengintegrasikan armada Anda ke dalam jaringan Siaga Ambulans, Anda memastikan kendaraan tersebut beroperasi maksimal melayani umat.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="relative max-w-5xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8 relative z-10">
                    ...
                    <div class="relative flex lg:flex-col gap-6 lg:gap-6 items-start lg:items-center text-left lg:text-center group">
                        <div class="w-20 h-20 shrink-0 bg-white border-4 border-slate-100 rounded-full flex items-center justify-center text-2xl font-black text-slate-400 shadow-sm group-hover:border-[#009CA6] group-hover:text-[#009CA6] transition-all duration-300">
                            01
                        </div>
                        <div>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                ...
                <div class="lg:col-span-5 sticky top-32">
                    ...
                    <div class="hidden lg:block w-48 h-48 bg-[#009CA6]/5 rounded-full blur-3xl absolute -bottom-20 -left-20"></div>
                </div>
                ...
                <div class="lg:col-span-7 bg-white border border-slate-200 p-8 md:p-12 rounded-3xl shadow-xl shadow-slate-200/40 relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-[#009CA6]/5 rounded-bl-full"></div>
                    <ul class="space-y-6 relative z-10">
                        <li class="flex items-start gap-5">
                            ...
                            <div>
                                <span class="text-lg text-[#0F2747] font-bold block mb-1">Identitas Pemilik/Pengelola</span>
                        ...
                        <li class="flex items-start gap-5">
                            ...
                            <div>
                                <span class="text-lg text-[#0F2747] font-bold block mb-1">Data Instansi/Faskes</span>
                                <span class="text-slate-600 font-medium">Informasi organisasi atau fasilitas kesehatan yang menaungi.</span>
                            </div>
                        </li>
                        <li class="flex items-start gap-5">
                            <div class="mt-1 w-8 h-8 shrink-0 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center shadow-sm">
                            ...
                            <div>
                                <span class="text-lg text-[#0F2747] font-bold block mb-1">Spesifikasi Kendaraan</span>
                                <span class="text-slate-600 font-medium">Detail jenis ambulans dan kelengkapan fasilitas medis.</span>
                            </div>
                        </li>
                        <li class="flex items-start gap-5">
                            <div class="mt-1 w-8 h-8 shrink-0 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center shadow-sm">
                            ...
                            <div>
                                <span class="text-lg text-[#0F2747] font-bold block mb-1">Dokumen Kendaraan</span>
                                <span class="text-slate-600 font-medium">STNK dan BPKB atau surat keterangan sah lainnya.</span>
                            </div>
                        </li>
                        <li class="flex items-start gap-5">
                            <div class="mt-1 w-8 h-8 shrink-0 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center shadow-sm">
                            ...
                            <div>
                                <span class="text-lg text-[#0F2747] font-bold block mb-1">Lokasi Pool & Kontak</span>
                                <span class="text-slate-600 font-medium">Alamat operasional yang jelas beserta kontak yang aktif.</span>
                            </div>
                        </li>
                        <li class="flex items-start gap-5">
                            <div class="mt-1 w-8 h-8 shrink-0 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center shadow-sm">
                            ...
                            <div>
                                <span class="text-lg text-[#0F2747] font-bold block mb-1">Dokumen Legalitas Lainnya</span>
                                <span class="text-slate-600 font-medium">Izin operasional atau surat pendukung sesuai ketentuan.</span>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <section class="py-24 px-6 lg:px-12 bg-white relative z-20">
        <div class="max-w-5xl mx-auto relative">
            ...
            <div class="absolute inset-0 bg-[#009CA6]/20 blur-3xl rounded-full transform translate-y-10 scale-95 pointer-events-none"></div>
            ...
            <div class="relative bg-gradient-to-br from-[#0F2747] to-[#1a3a66] rounded-[3rem] p-12 md:p-20 text-center shadow-[0_30px_60px_-15px_rgba(15,39,71,0.4)] overflow-hidden border border-white/10">
                ...
                <div class="absolute top-0 right-0 w-64 h-64 bg-[#009CA6]/30 blur-[80px] rounded-full pointer-events-none -mt-10 -mr-10"></div>
                ...
                <div class="relative z-10">
                    ...
                    <a href="{{ route('register.mitra') }}" class="group relative inline-flex items-center justify-center gap-3 bg-[#009CA6] text-white px-10 py-5 rounded-full font-black text-xl hover:bg-teal-400 hover:text-slate-900 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-teal-400/30 hover:-translate-y-1">
                        Daftar Sebagai Mitra Armada
