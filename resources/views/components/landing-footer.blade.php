<!-- Footer -->
<footer class="bg-[#0F2747] text-slate-400 pt-20 pb-10 px-6 lg:px-12 border-t border-slate-800 relative overflow-hidden">
    <!-- Decorative background elements -->
    <div class="absolute top-0 right-0 w-64 h-64 bg-[#009CA6]/10 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none"></div>
        ...
        <div class="lg:col-span-5 pr-0 lg:pr-12">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <span class="text-[#009CA6] text-xs font-bold tracking-widest uppercase mt-1 block">Siaga Darurat Medis</span>
                </div>
            </div>
            <p class="leading-relaxed mb-8 text-sm md:text-base font-medium text-slate-400">
            ...
            <div class="flex items-center gap-4">
                <a href="#" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#009CA6] hover:text-white hover:-translate-y-1 transition-all duration-300 shadow-lg group">
        ...
        <div class="lg:col-span-4">
            ...
            <div class="space-y-5">
                ...
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center shrink-0 border border-slate-700">
                        <svg class="w-5 h-5 text-[#009CA6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <div>
                        <span class="block text-white font-bold text-sm mb-1">Sekretariat Pusat</span>
                        <span class="text-sm font-medium leading-relaxed">{{ \App\Models\SettingAplikasi::getVal('alamat_kantor', 'Jl. Kemanusiaan No. 99, Kabupaten Cilacap, Jawa Tengah') }}</span>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between pt-8 border-t border-slate-800/80 font-medium text-xs md:text-sm relative z-10 gap-4">
        <p>&copy; {{ date('Y') }} {{ \App\Models\SettingAplikasi::getVal('nama_organisasi', 'LAZ Gerak Sedekah Cilacap') }}. Seluruh hak cipta dilindungi.</p>
        <div class="flex items-center gap-6 text-slate-500">
            <a href="#" class="hover:text-[#009CA6] transition-colors">Kebijakan Privasi</a>
            <a href="#" class="hover:text-[#009CA6] transition-colors">Syarat & Ketentuan</a>
        </div>
    </div>
</footer>
